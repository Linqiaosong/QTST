...
{
    std::cout<<"====================================================="<<std::endl;
    std::cout<<"\t  QD v1.4 量子动力学计算软件"<<std::endl;
    std::cout<<"\t\t Qiaosong Lin"<<std::endl;
    std::cout<<"\t    Wuhan University, 2019"<<std::endl;
    std::cout<<"若使用了本软件，请引用：\nQ. Lin,QD v1.4,https://github.com/Linqiaosong/QD"<<std::endl;
    std::cout<<"====================================================="<<std::endl;
    std::cout<<std::endl;
    std::cout<<"====================================================="<<std::endl;
    ...
    switch(option)
    {
        case 1:
        {
            ...
            {
                std::cout<<"\t\t*请输入生成过渡态的势垒ΔU（可选）*"<<std::endl;
                std::cout<<"\t*缺省生成过渡态的势垒数据请输入-1 -1 *"<<std::endl;
                std::cout<<std::endl;
                std::cout<<"注意，缺省生成过渡态的势垒将自动缺省放热方向校正系数，并进行近似的Skodje-Truhlar方法计算，在T<250 K时可能造成重大错误"<<std::endl;
        ...
        case 2:
        {
            std::cout<<"====================================================="<<std::endl;
            std::cout<<"\t\t*请选择计算方法*"<<std::endl;
            std::cout<<"[1] Gibbs自由能方法"<<std::endl;
            ...
            if(option1==2||option1==3)
            {
                ...
                std::cout<<"ΔU=U(T=0 K,过渡态)-U(T=0 K,反应物A)"<<std::endl;
                std::cout<<std::endl;
                std::cout<<"能量数值与单位之间用一个空格隔开，单位用标号表示"<<std::endl;
                std::cout<<"支持单位：\n[1] kJ/mol\n[2] kcal/mol\n[3] eV/粒子\n[4] Hartree/粒子"<<std::endl;
                std::cout<<"例：30.0 kJ/mol输入：30.0 1\nΔU=";
                ...
                {
                    std::cout<<"====================================================="<<std::endl;
                    std::cout<<"\t\t*请输入生成过渡态的Gibbs自由能ΔG*"<<std::endl;
        ...
        case 3:
        {
            ...
            if(option1==2||option1==3)
            {
                std::cout<<"====================================================="<<std::endl;
                std::cout<<"\t\t*请输入生成过渡态的能垒ΔU*"<<std::endl;
                std::cout<<"ΔU=U(T=0 K,过渡态)-[U(T=0 K,反应物A)+U(T=0 K,反应物B)]"<<std::endl;
                std::cout<<std::endl;
                std::cout<<"能量数值与单位之间用一个空格隔开，单位用标号表示"<<std::endl;
                std::cout<<"支持单位：\n[1] kJ/mol\n[2] kcal/mol\n[3] eV/粒子\n[4] Hartree/粒子"<<std::endl;
                std::cout<<"例：30.0 kJ/mol输入：30.0 1\nΔU=";
                ...
                else
                {
                    std::cout<<"====================================================="<<std::endl;
                    std::cout<<"\t\t*请输入生成过渡态的Gibbs自由能ΔG*"<<std::endl;
                    std::cout<<"ΔG=G(p=1 bar,T,过渡态)-[G(p=1 bar,T,反应物A)+G(p=1 bar,T,反应物B)]"<<std::endl;
                    std::cout<<std::endl;
                    std::cout<<"能量数值与单位之间用一个空格隔开，单位用标号表示"<<std::endl;
                    std::cout<<"支持单位：\n[1] kJ/mol\n[2] kcal/mol\n[3] eV/粒子\n[4] Hartree/粒子"<<std::endl;
                    std::cout<<"例：30.0 kJ/mol输入：30.0 1\nΔG=";
